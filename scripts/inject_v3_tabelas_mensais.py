...
CSV_PATH = r'C:\Users\NATHTA~1\AppData\Local\Temp\claude\C--Users-nathtavares\693b4b1a-97a9-4280-bd88-e5b02a3c74b9\scratchpad\v3_tabelas_mensais.csv'
...
# renomeia os campos da query (nomes internos) pros nomes usados no JS ja existente
RENAME = {'app_instalado_encendido': 'app_instalado', 'status_limite_reenc': 'status_limite', 'FLAG_TC': 'flag_tc'}
